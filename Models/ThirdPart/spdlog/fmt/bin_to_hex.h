...
to_hex(const Container &container, size_t size_per_line = 32)
{
    ...
    return details::dump_info<Iter>(
        std::begin(container), std::end(container), size_per_line);
}
...
struct formatter<spdlog::details::dump_info<T>, char>
{
    ...
    auto
    format(const spdlog::details::dump_info<Container> &the_range, FormatContext &ctx)
        -> decltype(ctx.out())
    {
