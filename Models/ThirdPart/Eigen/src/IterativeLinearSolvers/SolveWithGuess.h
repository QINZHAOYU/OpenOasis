...
template <typename Decomposition, typename RhsType, typename GuessType>
class SolveWithGuess : public internal::generic_xpr_base<
...
public:
    ...
    SolveWithGuess(
        const Decomposition &dec, const RhsType &rhs, const GuessType &guess) :
        m_dec(dec),
        m_rhs(rhs), m_guess(guess)
    {}
...
struct evaluator<SolveWithGuess<Decomposition, RhsType, GuessType>>
    : public evaluator<
          typename SolveWithGuess<Decomposition, RhsType, GuessType>::PlainObject>
{
...
template <
    typename DstXprType, typename DecType, typename RhsType, typename GuessType,
    typename Scalar>
struct Assignment<
    DstXprType, SolveWithGuess<DecType, RhsType, GuessType>,
