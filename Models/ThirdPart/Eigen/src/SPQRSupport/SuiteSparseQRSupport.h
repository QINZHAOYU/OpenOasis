 ...
 *
 * This class is used to perform a multithreaded and multifrontal rank-revealing QR
 * decomposition of sparse matrices. The result is then used to solve linear
 * leasts_square systems. Clearly, a QR factorization is returned such that A*P = Q*R
 * where :
 *
...
public:
    SPQR() :
        ...
        m_tolerance(NumTraits<Scalar>::epsilon()), m_cR(0), m_E(0), m_H(0), m_HPinv(0),
        m_HTau(0), m_useDefaultThreshold(true)
    {
    ...
    const MatrixType matrixR() const
    {
        ...
        {
            m_R =
                viewAsEigen<Scalar, ColMajor, typename MatrixType::StorageIndex>(*m_cR);
            m_isRUpToDate = true;
        }
        return m_R;
    }
...
struct SPQR_QProduct : ReturnByValue<SPQR_QProduct<SPQRType, Derived>>
{
    ...
    void evalTo(ResType &res) const
    {
        ...
        res =
            Matrix<Scalar, ResType::RowsAtCompileTime, ResType::ColsAtCompileTime>::Map(
