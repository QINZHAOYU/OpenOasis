 ...
 *
 * \param ExpressionType the type of the object of which we are forcing aligned packet
 * access
 *
...
inline typename internal::add_const_on_value_type<typename internal::conditional<
...
template <bool Enable>
inline
    typename internal::conditional<Enable, ForceAlignedAccess<Derived>, Derived &>::type
