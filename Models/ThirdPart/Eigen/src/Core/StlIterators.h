...
protected:
    ...
    typedef typename internal::conditional<
        internal::is_const<XprType>::value, non_const_iterator, const_iterator>::type
        other_iterator;
    // NOTE: in C++03 we cannot declare friend classes through typedefs because we need
    // to write friend class:
...
protected:
    typedef indexed_based_stl_iterator_traits<Derived> traits;
    typedef typename traits::XprType                   XprType;
    typedef indexed_based_stl_reverse_iterator_base<typename traits::non_const_iterator>
        non_const_iterator;
    typedef indexed_based_stl_reverse_iterator_base<typename traits::const_iterator>
        const_iterator;
    typedef typename internal::conditional<
        internal::is_const<XprType>::value, non_const_iterator, const_iterator>::type
        other_iterator;
...
class pointer_based_stl_iterator
{
    ...
    typedef pointer_based_stl_iterator<typename internal::remove_const<XprType>::type>
        non_const_iterator;
    typedef pointer_based_stl_iterator<typename internal::add_const<XprType>::type>
        const_iterator;
    typedef typename internal::conditional<
        internal::is_const<XprType>::value, non_const_iterator, const_iterator>::type
        other_iterator;
...
public:
    ...
    typedef std::random_access_iterator_tag iterator_category;
    typedef typename internal::conditional<
        bool(is_lvalue), value_type *, const value_type *>::type pointer;
    typedef typename internal::conditional<
        bool(is_lvalue), value_type &, const value_type &>::type reference;
...
struct indexed_based_stl_iterator_traits<generic_randaccess_stl_iterator<_XprType>>
{
    ...
    typedef generic_randaccess_stl_iterator<
        typename internal::remove_const<XprType>::type>
        non_const_iterator;
    typedef generic_randaccess_stl_iterator<typename internal::add_const<XprType>::type>
        const_iterator;
};
...
public:
    typedef typename internal::conditional<
        bool(is_lvalue), value_type *, const value_type *>::type pointer;
    typedef typename internal::conditional<
        bool(is_lvalue), value_type &, read_only_ref_t>::type reference;
...
protected:
    ...
    typedef typename internal::conditional<
        Direction == Vertical, typename XprType::ColXpr, typename XprType::RowXpr>::type
        SubVectorType;
    typedef typename internal::conditional<
...
public:
    typedef typename internal::conditional<
        bool(is_lvalue), SubVectorType, ConstSubVectorType>::type reference;
...
protected:
    ...
    typedef indexed_based_stl_reverse_iterator_base<subvector_stl_reverse_iterator>
        Base;
    using Base::m_index;
    using Base::mp_xpr;
...
/** returns an iterator to the element following the last element of the 1D vector or
 * array \only_for_vectors \sa begin(), cend()
 */
template <typename Derived>
...
/** returns a read-only const_iterator to the element following the last element of the
 * 1D vector or array \only_for_vectors \sa begin(), cend()
 */
template <typename Derived>
