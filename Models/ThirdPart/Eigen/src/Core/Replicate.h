 ...
 * \tparam RowFactor number of repetitions at compile time along the vertical direction,
 * can be Dynamic. \tparam ColFactor number of repetitions at compile time along the
 * horizontal direction, can be Dynamic.
 *
 * This class represents an expression of the multiple replication of a matrix or
 * vector. It is the return type of DenseBase::replicate() and most of the time this is
...
public:
    ...
    template <typename OriginalMatrixType>
    EIGEN_DEVICE_FUNC inline Replicate(
...
EIGEN_DEVICE_FUNC const typename VectorwiseOp<
    ExpressionType, Direction>::ReplicateReturnType
VectorwiseOp<ExpressionType, Direction>::replicate(Index factor) const
{
    return typename VectorwiseOp<ExpressionType, Direction>::ReplicateReturnType(
        _expression(),
        Direction == Vertical ? factor : 1,
