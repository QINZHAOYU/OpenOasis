...
struct PacketWrapper<PacketReturnType, 4>
{
    ...
    scalarize(Index index, PacketReturnType &in)
    {
        ...
        case 3: return in.w();
        default:
            // INDEX MUST BE BETWEEN 0 and 3.There is no abort function in SYCL kernel.
            // so we cannot use abort here.
...
struct PacketWrapper<PacketReturnType, 2>
{
    ...
    scalarize(Index index, PacketReturnType &in)
    {
        ...
        case 1: return in.y();
        default:
            // INDEX MUST BE BETWEEN 0 and 1.There is no abort function in SYCL kernel.
            // so we cannot use abort here.
            // The code will never reach here
            __builtin_unreachable();
        }
