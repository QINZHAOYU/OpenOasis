    ...
    : gebp_traits<float, float, false, false, Architecture::Generic, GEBPPacketFull>
{
    ...
    EIGEN_STRONG_INLINE void madd(
        const Packet4f &a, const Packet4f &b, Packet4f &c, Packet4f &tmp,
    ...
    template <typename LaneIdType>
    EIGEN_STRONG_INLINE void madd(
        const Packet4f &a, const QuadPacket<Packet4f> &b, Packet4f &c, Packet4f &tmp,
    ...
    : gebp_traits<float, float, false, false, Architecture::Generic, GEBPPacketFull>
{
    ...
    EIGEN_STRONG_INLINE void madd(
        const LhsPacket &a, const RhsPacket &b, AccPacket &c, RhsPacket & /*tmp*/,
    ...
    EIGEN_STRONG_INLINE void madd(
        const LhsPacket &a, const RhsPacketx4 &b, AccPacket &c, RhsPacket & /*tmp*/,
        const FixedInt<0> &) const
    {
        madd_helper<0>(a, b, c);
    }
...
private:
    template <int LaneID>
    EIGEN_STRONG_INLINE void
    madd_helper(const LhsPacket &a, const RhsPacketx4 &b, AccPacket &c) const
    {
