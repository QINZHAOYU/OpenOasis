...
/* Avoid recomputing abs when we know the score and they are the same. Not a true Eigen
 * functor.  */
...
struct functor_traits<scalar_expm1_op<Scalar>>
{
    enum
    {
        ...
        Cost =
            functor_traits<scalar_exp_op<Scalar>>::Cost  // TODO measure cost of expm1
    };
};
...
struct functor_traits<scalar_log_op<Scalar>>
{
    ...
    // The following numbers are based on the AVX implementation.
#ifdef EIGEN_VECTORIZE_FMA
                 // 8 pmadd, 6 pmul, 8 padd/psub, 16 other, can issue 2 add/mul/madd per
                 // cycle.
                 ?
...
struct functor_traits<scalar_log1p_op<Scalar>>
{
    enum
    {
        ...
        Cost =
            functor_traits<scalar_log_op<Scalar>>::Cost  // TODO measure cost of log1p
    };
};
...
// Boolean specialization to eliminate -Wimplicit-conversion-floating-point-to-bool
// warnings.
template <>
...
/** \internal
 * \brief Template functor to compute the rounded (with current rounding mode)  value of
 * a scalar \sa class CwiseUnaryOp, ArrayBase::rint()
 */
template <typename Scalar>
 ...
 */
template <
    typename Scalar, bool is_complex = (NumTraits<Scalar>::IsComplex != 0),
...
struct scalar_logistic_op<float>
{
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet packetOp(const Packet &_x) const
    {
        ...
        // evaluates to 1. Choosing this value saves us a few instructions clamping the
        // results at the end.
#ifdef EIGEN_VECTORIZE_FMA
