...
public:
    ...
    struct DiagonalIntReturnType
    {
        ...
        typedef typename internal::conditional<
            Conjugate, CwiseUnaryOp<internal::scalar_conjugate_op<Scalar>, BuildType>,
            BuildType>::type Type;
    };
 ...
 * #SelfAdjoint The former controls \ref TopicStorageOrders "storage order", and
 * defaults to column-major. The latter controls whether the matrix represents a
 * selfadjoint matrix in which case either Supers of Subs have to be null.
 *
...
public:
    ...
    explicit inline BandMatrix(
        Index rows = Rows, Index cols = Cols, Index supers = Supers,
        Index subs = Subs) :
...
template <
    typename _CoefficientsType, int _Rows, int _Cols, int _Supers, int _Subs,
    int _Options>
...
public:
    ...
    typedef
        typename internal::traits<BandMatrixWrapper>::CoefficientsType CoefficientsType;
    typedef typename internal::traits<BandMatrixWrapper>::StorageIndex StorageIndex;

    explicit inline BandMatrixWrapper(
        const CoefficientsType &coeffs, Index rows = _Rows, Index cols = _Cols,
