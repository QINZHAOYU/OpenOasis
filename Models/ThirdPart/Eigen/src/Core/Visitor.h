...
{
    // default initialization to avoid countless invalid maybe-uninitialized warnings by
    // gcc
    EIGEN_DEVICE_FUNC
 ...
 * \returns the minimum of all coefficients of *this and puts in *row and *col its
 * location.
 *
 ...
 * DenseBase::maxCoeff(IndexType*,IndexType*), DenseBase::visit(), DenseBase::minCoeff()
 */
template <typename Derived>
template <int NaNPropagation, typename IndexType>
EIGEN_DEVICE_FUNC typename internal::traits<Derived>::Scalar
 ...
 * \returns the maximum of all coefficients of *this and puts in *row and *col its
 * location.
 *
 * In case \c *this contains NaN, NaNPropagation determines the behavior:
 *   NaNPropagation == PropagateFast : undefined
