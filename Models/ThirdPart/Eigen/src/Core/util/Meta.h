...
/** \internal
 * \file Meta.h
 * This file contains generic metaprogramming classes which are not specifically related
...
struct numeric_limits<float>
{
    ...
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static float(min)()
    {
        return FLT_MIN;
    }
    EIGEN_DEVICE_FUNC
...
struct numeric_limits<double>
{
    ...
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static double(max)()
    {
        return DBL_MAX;
    }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static double(min)()
    {
        return DBL_MIN;
    }
    EIGEN_DEVICE_FUNC
...
{
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static int epsilon()
    {
        return 0;
    }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static int(max)()
    {
        return INT_MAX;
    }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static int(min)()
    {
        return INT_MIN;
    }
};
...
{
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static unsigned int epsilon()
    {
        return 0;
    }
    ...
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static unsigned int(min)()
    {
        return 0;
    }
};
...
{
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static long epsilon()
    {
        return 0;
    }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static long(max)()
    {
        return LONG_MAX;
    }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static long(min)()
    {
        return LONG_MIN;
    }
};
...
{
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static unsigned long epsilon()
    {
        return 0;
    }
    ...
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static unsigned long(min)()
    {
        return 0;
    }
};
...
{
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static long long epsilon()
    {
        return 0;
    }
...
{
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static bool epsilon()
    {
        return false;
    }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static bool(max)()
    {
        return true;
    }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static bool(min)()
    {
        return false;
    }
};
...
/** \internal
 * Provides access to the number of elements in the object of as a compile-time constant
 * expression. It "returns" Eigen::Dynamic if the size cannot be resolved at
...
{
    template <typename T>
    static has_std_result_type
    testFunctor(T const *, typename T::result_type const * = 0);
    template <typename T>
...
struct result_of<Func(ArgType)>
{
    ...
    template <typename T>
    static has_tr1_result
    testFunctor(T const *, typename T::template result<T(ArgType)>::type const * = 0);
    static has_none testFunctor(...);
...
template <
    typename Func, typename ArgType0, typename ArgType1, int SizeOf = sizeof(has_none)>
...
struct result_of<Func(ArgType0, ArgType1)>
{
    ...
    typedef
        typename binary_result_of_select<Func, ArgType0, ArgType1, FunctorType>::type
            type;
};

template <
    typename Func, typename ArgType0, typename ArgType1, typename ArgType2,
...
struct ternary_result_of_select<
    Func, ArgType0, ArgType1, ArgType2, sizeof(has_std_result_type)>
{
    typedef typename Func::result_type type;
};
...
template <typename Func, typename ArgType0, typename ArgType1, typename ArgType2>
struct ternary_result_of_select<
    Func, ArgType0, ArgType1, ArgType2, sizeof(has_tr1_result)>
{
    typedef
        typename Func::template result<Func(ArgType0, ArgType1, ArgType2)>::type type;
};
...
struct result_of<Func(ArgType0, ArgType1, ArgType2)>
{
    ...
    typedef typename ternary_result_of_select<
        Func, ArgType0, ArgType1, ArgType2, FunctorType>::type type;
};
...
#else
template <
    typename F, typename ArgType0 = void, typename ArgType1 = void,
...
struct has_unary_operator
{
    ...
    static meta_yes testFunctor(
        C const *,
        typename enable_if<
            (sizeof(return_ptr<C>()->operator()(IndexType(0))) > 0)>::type * = 0);
    static meta_no testFunctor(...);
...
struct has_binary_operator
{
    ...
    static meta_yes testFunctor(
        C const *,
        typename enable_if<
            (sizeof(return_ptr<C>()->operator()(IndexType(0), IndexType(0))) > 0)>::type
            * = 0);
    static meta_no testFunctor(...);
 ...
 */
template <
    int Y, int InfX = 0, int SupX = ((Y == 1) ? 1 : Y / 2),
    bool Done =
        ((SupX - InfX) <= 1 ? true :
                              ((SupX * SupX <= Y) && ((SupX + 1) * (SupX + 1) > Y)))>
...
/** \internal determines whether the product of two numeric types is allowed and what
 * the return type is */
template <typename T, typename U>
