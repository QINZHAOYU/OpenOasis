...
/** \class MatrixBase
  ...
  * This class is the base that is inherited by all matrix, vector, and related
  expression
  * types. Most of the Eigen API is contained in this class, and its base classes. Other
  important
  * classes for the Eigen API are Matrix, and VectorwiseOp.
  *
  * Note that some methods are defined in other modules such as the \ref LU_Module LU
  module
...
public:
    ...
    typedef Matrix<
        std::complex<RealScalar>, internal::traits<Derived>::ColsAtCompileTime, 1,
        ColMajor>
    ...
    typedef Block<
        const CwiseNullaryOp<internal::scalar_identity_op<Scalar>, SquareMatrixType>,
...
#undef EIGEN_DOC_UNARY_ADDONS
    ...
    bool
    isIdentity(const RealScalar &prec = NumTraits<Scalar>::dummy_precision()) const;
    bool
    isDiagonal(const RealScalar &prec = NumTraits<Scalar>::dummy_precision()) const;
    ...
    struct cross_product_return_type
    {
        ...
        typedef Matrix<
            Scalar, MatrixBase::RowsAtCompileTime, MatrixBase::ColsAtCompileTime>
            type;
    };
    ...
    makeHouseholder(EssentialPart &essential, Scalar &tau, RealScalar &beta) const;
    template <typename EssentialPart>
...
#define EIGEN_MATRIX_FUNCTION(ReturnType, Name, Description)                           \
    /** \returns an expression of the matrix Description of \c *this. \brief This      \
     * function requires the <a                                                        \
     * href="unsupported/group__MatrixFunctions__Module.html"> unsupported             \
     * MatrixFunctions module</a>. To compute the coefficient-wise Description use     \
     * ArrayBase::##Name . */                                                          \
...
#define EIGEN_MATRIX_FUNCTION_1(ReturnType, Name, Description, Argument)               \
    ...
    EIGEN_MATRIX_FUNCTION_1(
        MatrixPowerReturnValue, pow, power to \c p, const RealScalar &p)
    EIGEN_MATRIX_FUNCTION_1(
        MatrixComplexPowerReturnValue, pow, power to \c p,
