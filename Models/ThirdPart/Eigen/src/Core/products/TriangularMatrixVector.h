...
template <
    typename Index, int Mode, typename LhsScalar, bool ConjLhs, typename RhsScalar,
    bool ConjRhs, int StorageOrder, int Version = Specialized>
struct triangular_matrix_vector_product;

template <
    typename Index, int Mode, typename LhsScalar, bool ConjLhs, typename RhsScalar,
    bool ConjRhs, int Version>
struct triangular_matrix_vector_product<
    Index, Mode, LhsScalar, ConjLhs, RhsScalar, ConjRhs, ColMajor, Version>
{
        ...
        const RhsScalar &alpha)
{
    ...
    typedef Map<const Matrix<LhsScalar, Dynamic, Dynamic, ColMajor>, 0, OuterStride<>>
                 LhsMap;
...
template <
    ...
    bool ConjRhs, int Version>
struct triangular_matrix_vector_product<
    Index, Mode, LhsScalar, ConjLhs, RhsScalar, ConjRhs, RowMajor, Version>
{
    typedef typename ScalarBinaryOpTraits<LhsScalar, RhsScalar>::ReturnType ResScalar;
    enum
    {
        ...
        const ResScalar &alpha)
{
    ...
    typedef Map<const Matrix<LhsScalar, Dynamic, Dynamic, RowMajor>, 0, OuterStride<>>
                 LhsMap;
    const LhsMap lhs(_lhs, rows, cols, OuterStride<>(lhsStride));
    typename conj_expr_if<ConjLhs, LhsMap>::type cjLhs(lhs);
...
struct triangular_product_impl<Mode, true, Lhs, false, Rhs, true>
{
    ...
    static void
    run(Dest &dst, const Lhs &lhs, const Rhs &rhs, const typename Dest::Scalar &alpha)
    {
...
struct triangular_product_impl<Mode, false, Lhs, true, Rhs, false>
{
    ...
    run(Dest &dst, const Lhs &lhs, const Rhs &rhs, const typename Dest::Scalar &alpha)
    {
        ...
        internal::trmv_selector<
            (Mode & (UnitDiag | ZeroDiag)) | ((Mode & Lower) ? Upper : Lower),
...
// TODO: find a way to factorize this piece of code with gemv_selector since the logic
// is exactly the same.
