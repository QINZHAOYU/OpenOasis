...
{
    static void
    run(Index size, Scalar *mat, Index stride, const Scalar *vecX, const Scalar *vecY,
        const Scalar &alpha)
    {
...
template <
    typename MatrixType, typename OtherType, int UpLo,
...
{
    static void
    run(MatrixType &mat, const OtherType &other,
