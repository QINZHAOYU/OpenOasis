 ...
 * \tparam Direction defines the direction of the reverse operation, can be Vertical,
 * Horizontal, or BothDirections
 *
...
/** This is the "in place" version of VectorwiseOp::reverse: it reverses each column or
 * row of \c *this.
 *
 * In most cases it is probably better to simply use the reversed expression
 * of a matrix. However, when reversing the matrix data itself is really needed,
