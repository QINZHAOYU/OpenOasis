 ...
 * (optional) \tparam Cols the number of columns of the reshape we are taking at compile
 * time (optional) \tparam Order can be ColMajor or RowMajor, default is ColMajor.
 *
...
struct traits<Reshaped<XprType, Rows, Cols, Order>> : traits<XprType>
{
    ...
    enum
    {
        ...
        XpxStorageOrder = ((int(traits<XprType>::Flags) & RowMajorBit) == RowMajorBit) ?
                              RowMajor :
                              ColMajor,
        ...
        InnerSize = (ReshapedStorageOrder == int(RowMajor)) ? int(ColsAtCompileTime) :
        ...
        HasDirectAccess =
            internal::has_direct_access<XprType>::ret && (Order == int(XpxStorageOrder))
        ...
        // (((OuterStrideAtCompileTime * int(sizeof(Scalar))) % 16) == 0)) ? AlignedBit
        // : 0,
        ...
        Flags =
            (Flags0 | FlagsLinearAccessBit | FlagsLvalueBit | FlagsRowMajorBit
...
class Reshaped
    : public ReshapedImpl<
          XprType, Rows, Cols, Order, typename internal::traits<XprType>::StorageKind>
{
    typedef ReshapedImpl<
        XprType, Rows, Cols, Order, typename internal::traits<XprType>::StorageKind>
        Impl;
...
// internal::ReshapedImpl_dense that must be specialized for direct and non-direct
// access...
template <typename XprType, int Rows, int Cols, int Order>
...
public:
    ...
    {}
    EIGEN_DEVICE_FUNC inline ReshapedImpl(
        XprType &xpr, Index reshapeRows, Index reshapeCols) :
        Impl(xpr, reshapeRows, reshapeCols)
    {}
};
        ...
        FlagsLinearAccessBit =
            (traits<XprType>::RowsAtCompileTime == 1
             || traits<XprType>::ColsAtCompileTime == 1 || HasDirectAccess) ?
                ...
                0,
        FlagsRowMajorBit =
            (traits<XprType>::ReshapedStorageOrder == int(RowMajor)) ? RowMajorBit : 0,
        FlagsDirectAccessBit = HasDirectAccess ? DirectAccessBit : 0,
    ...
    : evaluator_base<Reshaped<ArgType, Rows, Cols, Order>>
{
    ...
    {
        CoeffReadCost =
            evaluator<ArgType>::CoeffReadCost /* TODO + cost of index computations */,
          ...
          typename Reshaped<ArgType, Rows, Cols, Order>::PlainObject>
{
    ...
    {
        // TODO: for the 3.4 release, this should be turned to an internal assertion,
