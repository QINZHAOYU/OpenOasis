...
template <
    typename LhsScalar, typename RhsScalar, typename Index, int Side, int Mode,
...
template <
    typename Lhs, typename Rhs, int Mode, int LoopIndex, int Size,
