...
typedef typename internal::conditional<
    NumTraits<Scalar>::IsComplex,
    CwiseUnaryView<internal::scalar_real_ref_op<Scalar>, Derived>, Derived &>::type
...
struct CastXpr
{
    typedef typename internal::cast_return_type<
        Derived,
        const CwiseUnaryOp<internal::scalar_cast_op<Scalar, NewType>, const Derived>>::
        type Type;
};
...
///
/// \sa <a href="group__CoeffwiseMathFunctions.html#cwisetable_conj">Math functions</a>,
/// MatrixBase::adjoint()
EIGEN_DEVICE_FUNC
...
/// \returns an expression of the complex conjugate of \c *this if Cond==true, returns
/// derived() otherwise.
///
EIGEN_DOC_UNARY_ADDONS(conjugate, complex conjugate)
///
...
EIGEN_DEVICE_FUNC inline
    typename internal::conditional<Cond, ConjugateReturnType, const Derived &>::type
    conjugateIf() const
{
    typedef
        typename internal::conditional<Cond, ConjugateReturnType, const Derived &>::type
...
///
/// The function \c ptr_fun() from the C++ standard library can be used to make functors
