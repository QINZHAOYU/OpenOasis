...
protected:
    ...
    static EIGEN_DEVICE_FUNC Scalar det3(
        const Derived &m, Index i0, const Scalar &d0, Index i1, const Scalar &d1,
        Index i2, const Scalar &d2)
    {
        return internal::pmadd(
            m(i0, 2), d0, internal::pmadd(-m(i1, 2), d1, m(i2, 2) * d2));
    }
};
...
MatrixBase<Derived>::determinant() const
{
    ...
    typedef
        typename internal::nested_eval<Derived, Base::RowsAtCompileTime>::type Nested;
