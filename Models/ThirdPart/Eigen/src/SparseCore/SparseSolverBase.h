 ...
 * The rhs is decomposed into small vertical panels which are solved through dense
 * temporaries.
 */
...
solve_sparse_through_dense_panels(const Decomposition &dec, const Rhs &rhs, Dest &dest)
{
    ...
    // we process the sparse rhs per block of NbColsAtOnce columns temporarily stored
    // into a dense matrix.
...
public:
    ...
    /** \returns an expression of the solution x of \f$ A x = b \f$ using the current
     * decomposition of A.
     *
     * \sa compute()
     */
    ...
    {
        internal::solve_sparse_through_dense_panels(
            derived(), b.derived(), dest.derived());
    }
