...
class PrettyWriter
    : public Writer<
          OutputStream, SourceEncoding, TargetEncoding, StackAllocator, writeFlags>
{
public:
    typedef Writer<
        OutputStream, SourceEncoding, TargetEncoding, StackAllocator, writeFlags>
    ...
    */
    explicit PrettyWriter(
        ...
        indentChar_(' '), indentCharCount_(4), formatOptions_(kFormatDefault)
    {}
    ...
    explicit PrettyWriter(
        ...
        indentChar_(' '), indentCharCount_(4)
    {}
    ...
    /*! \param indentChar       Character for indentation. Must be whitespace character
       (' ', '\\t', '\\n', '\\r'). \param indentCharCount  Number of indent characters
    ...
    */
    ...
    /*!
       ...
       of the root of json. \note When using PrettyWriter::RawValue(), the result json
       may not be indented correctly.
    */
